...
execute as @a[tag=class.magic] run function src:system/util/class_loadout/magic
execute as @a[tag=class.melee] run function src:system/util/class_loadout/melee
execute as @a[tag=class.ranged] run function src:system/util/class_loadout/ranged
