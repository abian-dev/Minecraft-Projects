...
execute if score %arena.enemiesAlive system.global matches ..0 unless score %arena.playersAlive system.global matches ..0 run function src:spawning/wave/next with storage spawning wave
