...
execute if score @s effect.burning.duration matches ..0 run scoreboard players reset @s effect.burning.duration
...
# fx
particle flame ~ ~1 ~ 0 0 0 0.1 5
particle lava ~ ~1 ~ 0 0 0 0.1 1
