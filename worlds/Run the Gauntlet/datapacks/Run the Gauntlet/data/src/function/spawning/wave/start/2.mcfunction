...
schedule function src:spawning/wave/start/2 5t append
scoreboard players add %gauntlet.wave.timer system.global 1
execute if score %gauntlet.wave.timer system.global matches 7.. run return run schedule clear src:spawning/wave/start/2
...
# shakeshack
execute if score %gauntlet.wave.timer system.global matches 3 run return run function src:spawning/summon/entity {"entity":"skeleton","id":"2","pos":"-59 71 -12"}
...
# tesla
execute if score %gauntlet.wave.timer system.global matches 5 run return run function src:spawning/summon/entity {"entity":"skeleton","id":"2","pos":"57 70 3"}
