...
$execute if score @s generic.math matches -1 run execute positioned ^ ^ ^-1 run function src:spawning/summon/entity {"entity":"$(entity)","id":"$(id)","pos":"^ ^ ^"}
$execute if score @s generic.math matches 0 run execute positioned ^ ^ ^ run function src:spawning/summon/entity {"entity":"$(entity)","id":"$(id)","pos":"^ ^ ^"}
