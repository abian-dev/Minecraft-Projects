...
# vfx
function src:generic/vfx/radial_forked_lightning/play {"inaccuracy":"20","rootsMin":"1","rootsMax":"2","branchesMin":"7","branchesMax":"8","branchLengthMin":"4","branchLengthMax":"5","particle":"dust{color:[0.5,1.0,1.0],scale:0.5}"}
