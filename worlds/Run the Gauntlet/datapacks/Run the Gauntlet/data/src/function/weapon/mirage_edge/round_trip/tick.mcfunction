...
# phases
execute unless score @s generic.math matches 50.. run scoreboard players add @s generic.math 1
execute if score @s generic.math matches ..10 run function src:weapon/mirage_edge/round_trip/move
execute if score @s generic.math matches 50.. run function src:weapon/mirage_edge/round_trip/end