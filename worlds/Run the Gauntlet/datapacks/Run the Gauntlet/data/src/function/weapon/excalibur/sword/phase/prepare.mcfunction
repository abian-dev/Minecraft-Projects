...
execute as @a[tag=excalibur.sword.user] at @s if score @s user.id = %excalibur.sword.search user.id as @e[type=item_display,limit=1,sort=nearest,tag=excalibur.sword.curr] rotated ~ 0 run tp @s ^ ^2.0 ^0.5 ~ -90
