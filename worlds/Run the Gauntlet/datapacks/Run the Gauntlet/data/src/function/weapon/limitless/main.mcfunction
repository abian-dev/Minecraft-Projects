## Called every tick
# moveset
execute if score @s in.sequence matches 1 if score @s in.rmb.on matches 1.. if score @s weapon.cd matches ..0 if score @s cost.energy matches 20.. run return run function src:weapon/limitless/red/reversal/use
execute if score @s in.sequence matches 11 if score @s in.rmb.on matches 1.. if score @s weapon.cd matches ..0 if score @s cost.energy matches 30.. run return run function src:weapon/limitless/red/flash/use

execute if score @s in.sequence matches 2 if score @s in.rmb.on matches 1.. if score @s weapon.cd matches ..0 if score @s cost.energy matches 30.. run return run function src:weapon/limitless/blue/attract/use
execute if score @s in.sequence matches 22 if score @s in.rmb.on matches 1.. if score @s weapon.cd matches ..0 if score @s cost.energy matches 30.. run return run function src:weapon/limitless/blue/lapse/use
