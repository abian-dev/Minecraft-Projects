...
execute anchored eyes facing entity @e[type=!#src:non_entity,distance=..40,scores={effect.lockedOn.duration=8..},tag=!rocketlauncher.lockon.user,team=!ally] eyes positioned ^ ^ ^3 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^ ~ ~
