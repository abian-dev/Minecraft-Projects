...
summon armor_stand ~ ~ ~ {Pose:{RightArm:[180f,180f,90f]},Invisible:1b,Marker:1b,DisabledSlots:4144959,Tags:["mirageedge.roundtrip"],equipment:{mainhand:{id:diamond_sword,components:{unbreakable:{},custom_model_data:{strings:["melee.mirageedge"]}}}}}
