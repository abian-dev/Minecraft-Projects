...
# fx
execute rotated ~ 0 positioned ^ ^1 ^-2 run function src:generic/vfx/slash_circle/play {"radius":"7","completion":"50","thickness":"1","accuracy":"70","speed":"30","pitch":"0","particle":"dust{color:[0.0,0.7,1.0],scale:1}"}
