...
execute rotated as @e[type=area_effect_cloud,limit=1,sort=nearest,tag=limitless.red.flash] rotated ~180 ~ positioned ~ ~0.1 ~ run function src:weapon/limitless/red/kb/step
