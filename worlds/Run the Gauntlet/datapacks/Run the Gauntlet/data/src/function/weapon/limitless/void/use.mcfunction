...
# fx
execute rotated ~ 0 positioned ^ ^1 ^-3 run function src:generic/vfx/domain/play {"accuracy":"300","radius":"1000","speed":"5","particle":"block_marker{block_state:{Name:black_concrete}}"}
