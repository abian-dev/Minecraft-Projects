...
$execute unless score %vfxSlashCircle.$(id).thicknessOffset generic.dz >= %vfxSlashCircle.$(id).thicknessAtStep generic.dz positioned as @s run function src:generic/vfx/slash_circle/draw_thickness with storage minecraft:vfx slashCircle.$(id)