...
# example call: function src:generic/functions/raycast_mode/ignore_entities/start {"length":"100","hitEnd":"function","hitBlock":"function","vfx":"function"}
## Raycast: Ignore Entities Start Function
# run raycast
$scoreboard players set @s generic.raycast.step $(length)
tag @s add genericRaycaster
$function src:generic/functions/raycast_mode/ignore_entities/step {"hitEnd":"$(hitEnd)","hitBlock":"$(hitBlock)","vfx":"$(vfx)"}
