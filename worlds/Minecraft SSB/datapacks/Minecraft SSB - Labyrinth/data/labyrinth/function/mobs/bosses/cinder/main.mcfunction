...
# bossbar
execute store result bossbar minecraft:labyrinth.bossbar.cinder value run data get entity @s Health
bossbar set minecraft:labyrinth.bossbar.cinder players @a[predicate=labyrinth:zones/boss/cinder]