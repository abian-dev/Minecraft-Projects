# example call: function labyrinth:generic/functions/slowcast/summon {"distance":"10","slowcaster":"genericSlowcaster"}
...
$scoreboard players set @e[type=area_effect_cloud,limit=1,sort=nearest,tag=$(slowcaster)] labyrinth.generic.raycast.dist $(distance)
