...
$execute if score @s labyrinth.generic.raycast.step matches 0.. positioned ^ ^ ^-$(inaccuracy) run function labyrinth:generic/vfx/slash_scatter/slash_bwd {"inaccuracy":"$(inaccuracy)","vfx":"$(vfx)"}