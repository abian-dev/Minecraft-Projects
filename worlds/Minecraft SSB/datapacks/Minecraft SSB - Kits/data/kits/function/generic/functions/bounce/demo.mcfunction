...
execute as @e[type=armor_stand,limit=1,sort=nearest] at @s run scoreboard players set @s kits.generic.raycast.dist 0
execute as @e[type=armor_stand,limit=1,sort=nearest] at @s run scoreboard players set @s kits.generic.raycast.step 1000
