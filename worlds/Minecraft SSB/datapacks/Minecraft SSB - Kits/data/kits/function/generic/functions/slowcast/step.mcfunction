...
$execute if score @s kits.generic.raycast.step matches -1 run return run function kits:generic/functions/slowcast/hit_block {"slowcaster":"$(slowcaster)","hitBlock":"$(hitBlock)"}
...
execute if score @s kits.generic.raycast.step matches 0 run tp @s ~ ~ ~
$execute if score @s kits.generic.raycast.step matches 1.. positioned ^ ^ ^0.5 run function kits:generic/functions/slowcast/step {"slowcaster":"$(slowcaster)","hitBlock":"$(hitBlock)","hitEntity":"$(hitEntity)","vfx":"$(vfx)"}