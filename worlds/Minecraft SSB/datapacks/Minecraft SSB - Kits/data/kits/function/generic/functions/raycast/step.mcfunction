...
$execute if score @s kits.generic.raycast.step matches -1 run return run function kits:generic/functions/raycast/hit_block {"hitBlock":"$(hitBlock)"}
...
$execute if score @s kits.generic.raycast.step matches 0.. positioned ^ ^ ^0.5 run function kits:generic/functions/raycast/step {"hitEnd":"$(hitEnd)","hitBlock":"$(hitBlock)","hitEntity":"$(hitEntity)","vfx":"$(vfx)"}