...
$execute if score @s kits.generic.raycast.step matches 0.. positioned ^ ^ ^-$(inaccuracy) run function kits:generic/vfx/slash_scatter/slash_bwd {"inaccuracy":"$(inaccuracy)","vfx":"$(vfx)"}