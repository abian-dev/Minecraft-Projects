...
$execute if score @s kits.generic.raycast.step matches -1 run return run function kits:generic/functions/precisecast/hit_block {"hitBlock":"$(hitBlock)"}
...
$execute if score @s kits.generic.raycast.step matches 0.. positioned ^ ^ ^0.5 run function kits:generic/functions/precisecast/step {"hitEnd":"$(hitEnd)","hitBlock":"$(hitBlock)","hitHead":"$(hitHead)","hitBody":"$(hitBody)","hitLegs":"$(hitLegs)","vfx":"$(vfx)"}