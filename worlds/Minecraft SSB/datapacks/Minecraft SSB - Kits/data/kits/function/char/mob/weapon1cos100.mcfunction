summon armor_stand ^ ^-1.5 ^1.5 {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["telekinesis","projectile"],equipment:{head:{id:"minecraft:sandstone",Count:1b}}}
summon armor_stand ^-0.5 ^-1.5 ^1.5 {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["telekinesis","projectile"],equipment:{head:{id:"minecraft:sandstone",Count:1b}}}
summon armor_stand ^0.5 ^-1.5 ^1.5 {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["telekinesis","projectile"],equipment:{head:{id:"minecraft:sandstone",Count:1b}}}
