execute as @p[tag=Noctis] at @s rotated ~45 0 positioned ~ ~1.2 ~ run function kits:generic/vfx/slash_circle/play {"radius":"4","completion":"150","thickness":"2","accuracy":"40","acceleration":"4","speed":"0","pitch":"360","particle":"dust{color:[1.000,1.000,1.000],scale:1.0}"}
