...
execute store result entity @s Motion[1] double 0.1 run scoreboard players get @s kits.dy
execute store result entity @s Motion[2] double 0.5 run scoreboard players get @s kits.dz

# Tags
tag @s add IsaacObjectKinesisThrown
tag @s add projectile
tag @s remove IsaacObjectKinesisGrabbed
