...
execute if entity @s[scores={kits.raycastTick2=2222..}] run summon area_effect_cloud ~ ~0.5 ~ {custom_particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:80,Tags:["GutsDragonslayerSmashDestination"]}
