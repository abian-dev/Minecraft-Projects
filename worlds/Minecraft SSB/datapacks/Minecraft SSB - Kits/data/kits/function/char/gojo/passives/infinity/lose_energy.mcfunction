## Loses cursed energy based on damage resisted
# initialize
scoreboard players set @s kits.timer3 5

# energy loss scales with damage resisted
scoreboard players operation @s kits.timer2 = @s kits.criterion.resistDmg
