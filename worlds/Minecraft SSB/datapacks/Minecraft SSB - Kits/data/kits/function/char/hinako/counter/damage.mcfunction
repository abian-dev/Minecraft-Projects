damage @s 9 bypass:player_attack by @p[tag=Hinako]
effect give @s minecraft:slowness 1 4 true
effect give @p[tag=Hinako] minecraft:instant_health 1 0 true
...
particle minecraft:flame ~ ~1 ~ 0.2 0.2 0.2 0.1 20 force
