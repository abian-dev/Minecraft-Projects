...
execute rotated ~ 0 positioned ^-0.5 ^1 ^1 run function labyrinth:generic/vfx/rotating_vertical/general/play {"speed":"190","duration":"20","vfx":"particle soul_fire_flame ^ ^ ^1"}
