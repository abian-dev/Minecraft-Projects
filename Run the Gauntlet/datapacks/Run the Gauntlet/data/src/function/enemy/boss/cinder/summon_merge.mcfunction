...
item replace entity @s weapon.mainhand with carrot_on_a_stick[attribute_modifiers=[{type:attack_damage,amount:0,slot:mainhand,operation:add_value,id:"1752117617212"}],unbreakable={}]
