...
execute store result score @s labyrinth.vec.dy run data get entity @p Pos[1] 1000
...
execute store result entity @s Motion[1] double 0.0002 run scoreboard players get @s labyrinth.vec.dy
