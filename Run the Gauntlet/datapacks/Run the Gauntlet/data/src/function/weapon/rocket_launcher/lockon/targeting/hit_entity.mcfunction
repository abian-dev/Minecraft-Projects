...
execute if entity @e[type=!#src:non_entity,distance=..2,limit=1,sort=nearest,scores={effect.lockedOn.duration=10..}] run return run scoreboard players set @s generic.raycast.step 0
