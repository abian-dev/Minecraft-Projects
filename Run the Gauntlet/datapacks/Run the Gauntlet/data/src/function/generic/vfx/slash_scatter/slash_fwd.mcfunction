...
$execute if score @s generic.raycast.step matches 0.. positioned ^ ^ ^$(inaccuracy) run function src:generic/vfx/slash_scatter/slash_fwd {"inaccuracy":"$(inaccuracy)","vfx":"$(vfx)"}