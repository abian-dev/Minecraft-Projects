...
# generic
execute if entity @s[tag=vfxDomain] run function src:generic/vfx/domain/run
execute if entity @s[tag=vfxExpandingCylinder] run function src:generic/vfx/expanding_cylinder/run
