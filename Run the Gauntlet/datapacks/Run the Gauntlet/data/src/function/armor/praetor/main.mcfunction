...
# dash
execute if predicate src:input/sneak if score @s armor.cd matches ..15 run function src:armor/praetor/dash/use
...
execute if entity @s[tag=praetor.hasJumpedOnce,tag=praetor.releasedInAir] if predicate src:input/jump run function src:armor/praetor/jump/use
