...
execute if data storage system.ui in[0] unless data storage system.ui in[1] run return run function src:system/ui/menu/on_click

## update page and history if nothing happened
function src:system/ui/menu/refresh